...
def validate(data_path, device, model, word2idx, entity2idx, model_name, return_hits_at_k,idx2entity):
    model.eval()
...
def perform_experiment(data_path, mode, entity_path, relation_path, entity_dict, relation_dict, neg_batch_size, batch_size, shuffle, num_workers, nb_epochs, embedding_dim, hidden_dim, relation_dim, gpu, use_cuda,patience, freeze, validate_every, num_hops, lr, entdrop, reldrop, scoredrop, l3_reg, model_name, decay, ls, w_matrix, bn_list, kg_type, valid_data_path=None, test_data_path=None):
    ...
    checkpoint_path = '/checkpoints/MetaQA/uniform'
    if mode=='train':
...
if hops in ['1', '2', '3']:
    ...
    # /home/ubuntu/capstone/data/MetaQA/qa_dev_1hop.txt
    data_path = 'home/ubuntu/capstone/data/MetaQA/qa_train_' + hops + '.txt'

valid_data_path = 'home/ubuntu/capstone/data/MetaQA/qa_dev_' + hops + '.txt'
test_data_path = 'home/ubuntu/capstone/data/MetaQA/qa_test_' + hops + '.txt'
...
entity_embedding_path = '/home/ubuntu/capstone/code/Negative Sampling Implementation/Random/Uniform/E.npy'
relation_embedding_path = '/home/ubuntu/capstone/code/Negative Sampling Implementation/Random/Uniform/R.npy'
entity_dict = '/home/ubuntu/capstone/data/MetaQA/raw/entities.dict'
relation_dict = '/home/ubuntu/capstone/data/MetaQA/raw/relations.dict'
